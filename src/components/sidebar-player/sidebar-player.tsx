...
import { SidebarPlayerImageWithSong } from './components/sidebar-player-image-with-song'
...
export function SidebarPlayer() {
  ...
  return (
    <div className={cn('space-y-2', expanded ? 'p-4 space-y-3' : 'p-3')}>
      <SidebarPlayerImageWithSong expanded={expanded} onToggleExpanded={() => setExpanded(!expanded)} />
